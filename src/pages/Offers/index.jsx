...
const OfferTypes = () => {
  ...
  return (
    <Box>
      <PageHeader title={"Offer Types"} subTitle={"View all of your Offer Types"} />
      <Flex gap="md" my="md" wrap={"wrap"}>
        <InputField placeholder={"Search here..."} style={{ flex: 1, minWidth: "200px" }} leftIcon={"search"} />
